...
<div class="container-fluid">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <a href="/lahan/create" class="btn btn-sm btn-success mb-3">Data Baru</a>
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th class="bg-info text-center text-light">Id</th>
                        <th class="bg-info text-center text-light">Pemilik Lahan</th>
                        <th class="bg-info text-center text-light">Status lahan</th>
                        <th class="bg-info text-center text-light">Keterangan</th>
                    </tr>
                </thead>
                </tfoot>
                <tbody>
