                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Entri Data Baru Desa
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <form action="/kecamatan" method="POST">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="small mb-1" for="inputFirstName">ID
                                                        Desa</label>
                                                    <input
                                                        class="form-control py-4 @error('id_desa') is-invalid @enderror"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    id="inputFirstName" type="text" placeholder="Nama Kecamatan"
                                                    name="nama_kecamatan" value="{{ old('nama_kecamatan') }}" required
                                                    autofocus />
                                        ...
                                        <div class="form-group mt-4 mb-0">
                                            <button type="submit" class="btn btn-lg w-100 btn-outline-primary"><i
