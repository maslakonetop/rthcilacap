                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Edit Data Kecamatan
                                        {{ $data->nama_kecamatan }}
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <form action="/kecamatan/{{ $data->id }}" method="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group mt-4 mb-0">
                                                <button type="submit"
                                                    class="btn btn-lg w-100 btn-outline-primary text-dark"><i
                                                        class="fas fa-edit"></i> Perbaharui Data</button>
                                            </div>
                                    </form>
                                </div>
                            </div>
